                                        ...
                                        <div className="card card-hover">
                                            ...
                                            <div className="card-body">
                                                <div className="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <a href="#" className="fs-5" onClick={() => addToWishlist(w.course?.id)}>
                                                ...
                                                <small>{w.course.students?.length} Student
                                                {w.course.students?.length > 1 && "s"}</small> <br />
                                            ...
                                            <div className="card-footer">
                                                <div className="row align-items-center g-0">
                                                    ...
                                                    <div className="col-auto">
                                                        <button type="button" onClick={() => addToCart(w.course.id, userId, w.course.price, country, cartId)} className="text-inherit text-decoration-none btn btn-primary me-2">
