                  ...
                  <div className="d-lg-flex align-items-center justify-content-between">
                    <div className="d-flex align-items-center mb-4 mb-lg-0">
                      ...
                      <div className="ms-3">
                        ...
                        <input type="file" className='form-control mt-3' name="image"
                  ...
                  <div>
                    ...
                    <div className="row gx-3">
                      ...
                      <div className="mb-3 col-12 col-md-12">
                        ...
                        <textarea id="" cols="30" rows="5" className='form-control' value={profileData.about}
                        onChange={handleProfileChange} name="about"></textarea>
