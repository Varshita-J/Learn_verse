        ...
        <div className="row">
          <div className="col-lg-4 col-md-6 col-12 text-white">
            ...
            <div className="mb-4">
              ...
              <div className="mt-4">
                <p>
                LearnVerse is a full-stack LMS inspired by Udemy, built with Django, Node.js, React, and Bootstrap. Explore courses with a responsive and seamless experience.
                </p>
                {/* social media */}
          ...
          <div className="col-lg-3 col-md-12">
            ...
            <div className="mb-4">
              ...
              <p className="mb-1">
                Email:
                <a href="#" className='text-white'> support@learnverse.com</a>
              </p>
              <p>
                Phone:
