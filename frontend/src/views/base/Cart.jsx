                                        ...
                                        <table className="table align-middle p-4 mb-0">
                                            ...
                                            { cart?.map((c, index) => 
                                                ...
                                                <td>
                                                    <button 
                                                    type = "button"
                                                    onClick = {() => cartItemDelete(c.id)} className="btn btn-sm btn-danger px-2 mb-0">
                                    ...
                                    <div className="row g-3 mt-0">
                                        ...
                                        <div className="col-md-12 bg-light-input">
                                            ...
                                            <input
                                                ...
                                                id="yourName"
                                                placeholder="Name"
                                                name="full_name" value={bioData.full_name} onChange={handleBioDataChange}
                                            />
                                        </div>
                                        {/* Email */}
                                        <div className="col-md-12 bg-light-input">
                                            ...
                                            <input
                                                ...
                                                id="emailInput"
                                                placeholder="Email"
                                                name="email" value={bioData.email} onChange={handleBioDataChange}
                                            />
                                        </div>
                                        ...
                                        <div className="col-md-12 bg-light-input">
                                            ...
                                            <input
                                                ...
                                                id="mobileNumber"
                                                placeholder="Country"
                                                name="country" value={bioData.country} onChange={handleBioDataChange}
                                            />
                                        </div>
